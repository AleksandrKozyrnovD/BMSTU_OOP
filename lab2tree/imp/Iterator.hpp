...
template <Comparable Type>
Iterator<Type>::Iterator(const ConstIterator<value_type> &iterator) noexcept: BaseIterator(iterator),
                                                                         root_{iterator.root()}, index_{iterator.index()},
                                                                         ptr_{iterator.ptr()} { size = iterator.size; }
...
Iterator<Type> Iterator<Type>::operator+(const size_t diff) const
{
...
template <Comparable Type>
Iterator<Type> &Iterator<Type>::operator+=(const size_t diff)
{
