...
{
	shared_ptr<Tree<Type>::TreeNode> cur_ptr = root_;
	...
	Tree<Type>::TreeNode tmpNode;
	shared_ptr<Tree<Type>::TreeNode> new_ptr = tmpNode.allocateNode();
...
bool Tree<Type>::Delete(const Type &data) {
	...
	shared_ptr<Tree<Type>::TreeNode> cur_ = root_;
	shared_ptr<Tree<Type>::TreeNode> prev_ = nullptr;
	...
	if (cur_->left() == nullptr || cur_->right() == nullptr) {
		...
		shared_ptr<Tree<Type>::TreeNode> new_cur_;
		...
		shared_ptr<Tree<Type>::TreeNode> p_ = nullptr;
		shared_ptr<Tree<Type>::TreeNode> tmp_;
...
{
	shared_ptr<Tree<Type>::TreeNode> cur = root_;
...
template <Comparable Type>
ConstIterator<Type> Tree<Type>::begin() noexcept
{
	return  const_iterator(root_, root_, 0, size);
}

template <Comparable Type>
ConstIterator<Type> Tree<Type>::end() noexcept
{
...
template <Comparable Type>
template <Convertable_To<Type> OtherType>
bool Tree<Type>::IsEquivalent(const Tree<common_type_t<Type, OtherType>>& tree) const
{
	if (size != tree.Size())
		return false;
...
template <Comparable Type>
template <Convertable_To<Type> OtherType>
bool Tree<Type>::IsNotEquivalent(const Tree<common_type_t<Type, OtherType>>& tree) const
{
	return !IsEquivalent(tree);
}
...
template <InputIterator I>
requires requires(typename I::value_type t) {{ t } -> convertible_to<Type>; }
Tree<common_type_t<Type, typename I::value_type>> Tree<Type>::CopyAdd(I begin, I end) const
{
	Tree<common_type_t<Type, typename I::value_type>> res(*this);
...
template <ContainerComparable Cont>
requires requires(typename Cont::value_type t) {{ t } -> convertible_to<Type>; }
Tree<common_type_t<Type, typename Cont::value_type>> Tree<Type>::CopyAdd(const Cont &container)
{
	Tree<common_type_t<Type, typename Cont::value_type>> res(*this);
...
template <Comparable Type>
template <Convertable_To<Type> OtherType>
Tree<common_type_t<Type, OtherType>> Tree<Type>::CopyAdd(const Tree<OtherType> &tree) const
{

	Tree<common_type_t<Type, OtherType>> res(*this);
...
template <Comparable Type>
template <Convertable_To<Type> OtherType>
Tree<common_type_t<Type, OtherType>> Tree<Type>::CopyAdd(const OtherType &num) const
{
	Tree<common_type_t<Type, OtherType>> res(*this);
...
template <Comparable Type>
template <Convertable_To<Type> OtherType>
Tree<common_type_t<Type, OtherType>> Tree<Type>::CopyAdd(const initializer_list<OtherType> elements) const
{
	Tree<common_type_t<Type, OtherType>> res(*this);
...
void Tree<Type>::allocateRoot()
{
	...
	{
		Tree<Type>::TreeNode tmpNode;
		shared_ptr<Tree<Type>::TreeNode> tmp = tmpNode.allocateNode();
		root_ = tmp;
	}
